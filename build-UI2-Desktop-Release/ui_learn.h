...
"font-size:26pt;\n"
"font-weight:bold;"));
        connection = new QLabel(Header_2);
        connection->setObjectName(QStringLiteral("connection"));
        connection->setGeometry(QRect(820, 60, 281, 61));
...
"font-size: 21px;"));
        ...
        back->setGeometry(QRect(10, 180, 131, 41));
        tableWidget = new QTableWidget(Body);
        tableWidget->setObjectName(QStringLiteral("tableWidget"));
        tableWidget->setGeometry(QRect(150, 140, 611, 511));
