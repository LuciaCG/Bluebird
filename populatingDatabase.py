...
newMovieIronMan = models.Movies(movieTitle="Iron Man", synopsis="After being held captive in an Afghan cave, billionaire engineer Tony Stark creates a unique weaponized suit of armor to fight evil.", ageRating="12A", director="Jon Favreau", leadActors="Robert Downey Jr., Terrence Howard, Gwyneth Paltrow, Jeff Bridges", moviePoster="app/static/images/IronManPoster.jpg", carasellPoster="app/static/images/image")
newMovieTheIncredibleHulk = models.Movies(movieTitle="The Incredible Hulk", synopsis="Bruce Banner, a scientist on the run from the U.S. Government, must find a cure for the monster he turns into, whenever he loses his temper.", ageRating="12", director="Louis Leterrier", leadActors="Edward Norton, Liv Tyler, Tim Roth", moviePoster="app/static/images/HulkPoster.jpg", carasellPoster="app/static/images/image")
newMovieIronMan2 = models.Movies(movieTitle="Iron Man 2", synopsis="With the world now aware of his identity as Iron Man, Tony Stark must contend with both his declining health and a vengeful mad man with ties to his father's legacy.", ageRating="12", director="Jon Favreau", leadActors="Robert Downey Jr., Don Cheadle, Gwyneth Paltrow, Scarlett Johansson, Mickey Rourke,", moviePoster="app/static/images/IronMan2Poster.jpg", carasellPoster="app/static/images/image")
newMovieThor = models.Movies(movieTitle="Thor", synopsis="The powerful, but arrogant god Thor, is cast out of Asgard to live amongst humans in Midgard (Earth), where he soon becomes one of their finest defenders.", ageRating="12", director="Kenneth Branagh", leadActors="Chris Hemsworth, Anthony Hopkins, Natalie Portman", moviePoster="app/static/images/ThorPoster.jpg", carasellPoster="app/static/images/image")
newMovieCaptainAmericaTFA = models.Movies(movieTitle="Captain America: The First Avenger", synopsis="Steve Rogers, a rejected military soldier transforms into Captain America after taking a dose of a \"Super-Soldier serum\". But being Captain America comes at a price as he attempts to take down a war monger and a terrorist organization.", ageRating="12", director="Joe Johnston", leadActors="Chris Evans, Hugo Weaving, Samuel L. Jackson, Hayley Atwell", moviePoster="app/static/images/CaptainAmerica1Poster.jpg", carasellPoster="app/static/images/image")
newMovieTheAvengers = models.Movies(movieTitle="Avengers Assemble", synopsis="Earth's mightiest heroes must come together and learn to fight as a team if they are going to stop the mischievous Loki and his alien army from enslaving humanity.", ageRating="12", director="Joss Whedon", leadActors="Robert Downey Jr., Chris Evans, Scarlett Johansson, Mark Ruffalo, Chris Hemsworth, Tom Hiddleston", moviePoster="app/static/images/Avengers1Poster.jpg", carasellPoster="app/static/images/image")
newMovieIronMan3 = models.Movies(movieTitle="Iron Man 3", synopsis="When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.", ageRating="12", director="Shane Black", leadActors="Robert Downey Jr., Guy Pearce, Gwyneth Paltrow", moviePoster="app/static/images/IronMan3Poster.jpg", carasellPoster="app/static/images/image")
newMovieThorTheDarkWorld = models.Movies(movieTitle="Thor: The Dark World", synopsis="When Dr. Jane Foster gets cursed with a powerful entity known as the Aether, Thor is heralded of the cosmic event known as the Convergence and the genocidal Dark Elves.", ageRating="12", director="Alan Taylor", leadActors="Chris Hemsworth, Natalie Portman, Christopher Eccleston", moviePoster="app/static/images/Thor2Poster.jpg", carasellPoster="app/static/images/image")
newMovieCaptainAmericaTWS = models.Movies(movieTitle="Captain America: The Winter Soldier", synopsis="As Steve Rogers struggles to embrace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat from history: an assassin known as the Winter Soldier.", ageRating="12", director="Joe Russo, Anthony Russo", leadActors="Chris Evans, Samuel L. Jackson, Scarlett Johansson, Robert Redford, Sebastian Stan, Anthony Mackie", moviePoster="app/static/images/CaptainAmerica2Poster.jpg", carasellPoster="app/static/images/image")
newMovieGuardiansoftheGalaxy = models.Movies(movieTitle="Guardians of the Galaxy", synopsis="A group of intergalactic criminals are forced to work together to stop a fanatical warrior from taking control of the universe.", ageRating="12", director="James Gunn", leadActors="Chris Pratt, Zoe Saldana, Dave Bautista, Bradley Cooper, Vin Diesel, Lee Pace", moviePoster="app/static/images/GoGPoster.jpg", carasellPoster="app/static/images/guardiansOfTheGalaxyWidePoster.jpg")
newMovieAvengersAOU = models.Movies(movieTitle="Avengers: Age of Ultron", synopsis="When Tony Stark and Bruce Banner try to jump-start a dormant peacekeeping program called Ultron, things go horribly wrong and it's up to Earth's mightiest heroes to stop the villainous Ultron from enacting his terrible plan.", ageRating="12", director="Joss Whedon", leadActors="Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth, James Spader", moviePoster="app/static/images/Avengers2Poster.jpg", carasellPoster="app/static/images/image")
newMovieAntMan = models.Movies(movieTitle="Ant-Man", synopsis="Forced out of his own company by former protege Darren Cross, Dr. Hank Pym (Michael Douglas) recruits the talents of Scott Lang (Paul Rudd), a master thief just released from prison. Lang becomes Ant-Man, trained by Pym and armed with a suit that allows him to shrink in size, possess superhuman strength and control an army of ants. The miniature hero must use his new skills to prevent Cross, also known as Yellowjacket, from perfecting the same technology and using it as a weapon for evil.", ageRating="12A", director="Peyton Reed", leadActors="Paul Rudd, Michael Douglas, Corey Stoll, Evangeline Lilly", moviePoster="app/static/images/Ant-ManPoster.jpg", carasellPoster="app/static/images/image")
newMovieCaptainAmericaCivilWar = models.Movies(movieTitle="Captain America: Civil War", synopsis="Political pressure mounts to install a system of accountability when the actions of the Avengers lead to collateral damage. The new status quo deeply divides members of the team. Captain America (Chris Evans) believes superheroes should remain free to defend humanity without government interference. Iron Man (Robert Downey Jr.) sharply disagrees and supports oversight. As the debate escalates into an all-out feud, Black Widow (Scarlett Johansson) and Hawkeye (Jeremy Renner) must pick a side.", ageRating="12A", director="Anthony Russo, Joe Russo", leadActors="Chris Evans, Robert Downey Jr., Scarlett Johansson", moviePoster="app/static/images/CaptainAmericaCivilWarPoster.jpg", carasellPoster="app/static/images/CaptainAmericaCivilWar.jpg")
newMovieDoctorStrange = models.Movies(movieTitle="Doctor Strange", synopsis="While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.", ageRating="12A", director="Scott Derrickson", leadActors="Benedict Cumberbatch, Chiwetel Ejiofor, Rachel McAdams, Tilda Swinton, Mads Mikkelsen", moviePoster="app/static/images/DoctorStrangePoster.jpg", carasellPoster="app/static/images/image")
newMovieGuardiansoftheGalaxy2 = models.Movies(movieTitle="Guardians of the Galaxy: Vol. 2", synopsis="The Guardians must fight to keep their newfound family together as they unravel the mystery of Peter Quill's true parentage.", ageRating="12A", director="James Gunn", leadActors="Chris Pratt, Zoe Saldana, Dave Bautista, Bradley Cooper, Vin Diesel, Kurt Russell", moviePoster="app/static/images/GoG2Poster.jpg", carasellPoster="app/static/images/guardiansOfTheGalaxyWidePoster.jpg")
newMovieSpiderManHomecoming = models.Movies(movieTitle="Spider-Man: Homecoming", synopsis="Thrilled by his experience with the Avengers, young Peter Parker returns home to live with his Aunt May. Under the watchful eye of mentor Tony Stark, Parker starts to embrace his newfound identity as Spider-Man. He also tries to return to his normal daily routine -- distracted by thoughts of proving himself to be more than just a friendly neighborhood superhero. Peter must soon put his powers to the test when the evil Vulture emerges to threaten everything that he holds dear.", ageRating="12A", director="Jon Watts", leadActors="Tom Holland, Michael Keaton, Robert Downey Jr.", moviePoster="app/static/images/SpidermanHomecomingPoster.jpg", carasellPoster="app/static/images/image")
newMovieThorRagnarok = models.Movies(movieTitle="Thor: Ragnarok", synopsis="Thor is imprisoned on the planet Sakaar, and must race against time to return to Asgard and stop Ragnarok, the destruction of his world, which is at the hands of the powerful and ruthless villain Hela.", ageRating="12A", director="Taika Waititi", leadActors="Chris Hemsworth, Tom Hiddleston, Cate Blanchett, Mark Ruffalo", moviePoster="app/static/images/ThorRagnarokPoster.jpg", carasellPoster="app/static/images/ThorCaresellPoster.jpg")
newMovieBlackPanther = models.Movies(movieTitle="Black Panther", synopsis="T'Challa, the King of Wakanda, rises to the throne in the isolated, technologically advanced African nation, but his claim is challenged by a vengeful outsider who was a childhood victim of T'Challa's father's mistake", ageRating="12A", director="Ryan Coogler", leadActors="Chadwick Boseman, Michael B. Jordan, Lupita Nyong'o", moviePoster="app/static/images/Black-Panther-poster.jpg", carasellPoster="app/static/images/image")
newMovieAvengersIW = models.Movies(movieTitle="Avengers: Infinity War", synopsis="The Avengers and their allies must be willing to sacrifice all in an attempt to defeat the powerful Thanos before his blitz of devastation and ruin puts an end to the universe.", ageRating="12A", director="Anthony Russo, Joe Russo", leadActors="Robert Downey Jr., Chris Evans, Chris Hemsworth, Karen Gillan, Tom Holland, Scarlett Johansson, Chris Pratt, Zoe Saldana", moviePoster="app/static/images/Avengers3Poster.jpg", carasellPoster="app/static/images/image")
newMovieAntManandtheWasp = models.Movies(movieTitle="Ant-Man and the Wasp", synopsis="As Scott Lang balances being both a Super Hero and a father, Hope van Dyne and Dr. Hank Pym present an urgent new mission that finds the Ant-Man fighting alongside The Wasp to uncover secrets from their past.", ageRating="12A", director="Peyton Reed", leadActors="Hannah John-Kamen, Paul Rudd, Evangeline Lilly", moviePoster="app/static/images/Ant-Man2Poster.jpeg", carasellPoster="app/static/images/image")
newMovieCaptainMarvel = models.Movies(movieTitle="Captain Marvel", synopsis="Carol Danvers becomes one of the universe's most powerful heroes when Earth is caught in the middle of a galactic war between two alien races.", ageRating="12A", director="Anna Boden, Ryan Fleck", leadActors="Ben Mendelsohn, Brie Larson, Lee Pace", moviePoster="app/static/images/CaptainMarvel.jpg", carasellPoster="app/static/images/image")
newMovieAvengers4 = models.Movies(movieTitle="Untitled Avengers Movie", synopsis="The plot is yet to be revealed. Will be the 4th installment of the 'Avengers' series.", ageRating="12A", director="Anthony Russo, Joe Russo", leadActors="Robert Downey Jr., Chris Evans, Chris Hemsworth, Karen Gillan, Tom Holland, Scarlett Johansson, Chris Pratt, Zoe Saldana", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
