...
newMovieIronMan = models.Movies(movieTitle="Iron Man", synopsis="After being held captive in an Afghan cave, billionaire engineer Tony Stark creates a unique weaponized suit of armor to fight evil.", ageRating="12A", director="Jon Favreau", leadActors="Robert Downey Jr., Terrence Howard, Gwyneth Paltrow, Jeff Bridges")
newMovieTheIncredibleHulk = models.Movies(movieTitle="The Incredible Hulk", synopsis="Bruce Banner, a scientist on the run from the U.S. Government, must find a cure for the monster he turns into, whenever he loses his temper.", ageRating="12", director="Louis Leterrier", leadActors="Edward Norton, Liv Tyler, Tim Roth")
newMovieIronMan2 = models.Movies(movieTitle="Iron Man 2", synopsis="With the world now aware of his identity as Iron Man, Tony Stark must contend with both his declining health and a vengeful mad man with ties to his father's legacy.", ageRating="12", director="Jon Favreau", leadActors="Robert Downey Jr., Don Cheadle, Gwyneth Paltrow, Scarlett Johansson, Mickey Rourke,")
newMovieThor = models.Movies(movieTitle="Thor", synopsis="The powerful, but arrogant god Thor, is cast out of Asgard to live amongst humans in Midgard (Earth), where he soon becomes one of their finest defenders.", ageRating="12", director="Kenneth Branagh", leadActors="Chris Hemsworth, Anthony Hopkins, Natalie Portman")
newMovieCaptainAmericaTFA = models.Movies(movieTitle="Captain America: The First Avenger", synopsis="Steve Rogers, a rejected military soldier transforms into Captain America after taking a dose of a \"Super-Soldier serum\". But being Captain America comes at a price as he attempts to take down a war monger and a terrorist organization.", ageRating="12", director="Joe Johnston", leadActors="Chris Evans, Hugo Weaving, Samuel L. Jackson, Hayley Atwell")
newMovieTheAvengers = models.Movies(movieTitle="Avengers Assemble", synopsis="Earth's mightiest heroes must come together and learn to fight as a team if they are going to stop the mischievous Loki and his alien army from enslaving humanity.", ageRating="12", director="Joss Whedon", leadActors="Robert Downey Jr., Chris Evans, Scarlett Johansson, Mark Ruffalo, Chris Hemsworth, Tom Hiddleston")
newMovieIronMan3 = models.Movies(movieTitle="Iron Man 3", synopsis="When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.", ageRating="12", director="Shane Black", leadActors="Robert Downey Jr., Guy Pearce, Gwyneth Paltrow")
newMovieThorTheDarkWorld = models.Movies(movieTitle="Thor: The Dark World", synopsis="When Dr. Jane Foster gets cursed with a powerful entity known as the Aether, Thor is heralded of the cosmic event known as the Convergence and the genocidal Dark Elves.", ageRating="12", director="Alan Taylor", leadActors="Chris Hemsworth, Natalie Portman, Christopher Eccleston")
newMovieCaptainAmericaTWS = models.Movies(movieTitle="Captain America: The Winter Soldier", synopsis="As Steve Rogers struggles to embrace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat from history: an assassin known as the Winter Soldier.", ageRating="12", director="Joe Russo, Anthony Russo", leadActors="Chris Evans, Samuel L. Jackson, Scarlett Johansson, Robert Redford, Sebastian Stan, Anthony Mackie")
newMovieGuardiansoftheGalaxy = models.Movies(movieTitle="Guardians of the Galaxy", synopsis="A group of intergalactic criminals are forced to work together to stop a fanatical warrior from taking control of the universe.", ageRating="12", director="James Gunn", leadActors="Chris Pratt, Zoe Saldana, Dave Bautista, Bradley Cooper, Vin Diesel, Lee Pace")
newMovieAvengersAOU = models.Movies(movieTitle="Avengers: Age of Ultron", synopsis="When Tony Stark and Bruce Banner try to jump-start a dormant peacekeeping program called Ultron, things go horribly wrong and it's up to Earth's mightiest heroes to stop the villainous Ultron from enacting his terrible plan.", ageRating="12", director="Joss Whedon", leadActors="Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth, James Spader")
newMovieAntMan = models.Movies(movieTitle="Ant-Man", synopsis="Forced out of his own company by former protege Darren Cross, Dr. Hank Pym (Michael Douglas) recruits the talents of Scott Lang (Paul Rudd), a master thief just released from prison. Lang becomes Ant-Man, trained by Pym and armed with a suit that allows him to shrink in size, possess superhuman strength and control an army of ants. The miniature hero must use his new skills to prevent Cross, also known as Yellowjacket, from perfecting the same technology and using it as a weapon for evil.", ageRating="12A", director="Peyton Reed", leadActors="Paul Rudd, Michael Douglas, Corey Stoll, Evangeline Lilly")
newMovieCaptainAmericaCivilWar = models.Movies(movieTitle="Captain America: Civil War", synopsis="Political pressure mounts to install a system of accountability when the actions of the Avengers lead to collateral damage. The new status quo deeply divides members of the team. Captain America (Chris Evans) believes superheroes should remain free to defend humanity without government interference. Iron Man (Robert Downey Jr.) sharply disagrees and supports oversight. As the debate escalates into an all-out feud, Black Widow (Scarlett Johansson) and Hawkeye (Jeremy Renner) must pick a side.", ageRating="12A", director="Anthony Russo, Joe Russo", leadActors="Chris Evans, Robert Downey Jr., Scarlett Johansson")
newMovieDoctorStrange = models.Movies(movieTitle="Doctor Strange", synopsis="While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.", ageRating="12A", director="Scott Derrickson", leadActors="Benedict Cumberbatch, Chiwetel Ejiofor, Rachel McAdams, Tilda Swinton, Mads Mikkelsen")
newMovieGuardiansoftheGalaxy2 = models.Movies(movieTitle="Guardians of the Galaxy: Vol. 2", synopsis="The Guardians must fight to keep their newfound family together as they unravel the mystery of Peter Quill's true parentage.", ageRating="12A", director="James Gunn", leadActors="Chris Pratt, Zoe Saldana, Dave Bautista, Bradley Cooper, Vin Diesel, Kurt Russell")
