...
newMovieTheAvengers = models.Movies(movieTitle="Avengers Assemble", synopsis="Earth's mightiest heroes must come together and learn to fight as a team if they are going to stop the mischievous Loki and his alien army from enslaving humanity.", ageRating="12", director="Joss Whedon", leadActors="Robert Downey Jr., Chris Evans, Scarlett Johansson, Mark Ruffalo, Chris Hemsworth, Tom Hiddleston", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
newMovieIronMan3 = models.Movies(movieTitle="Iron Man 3", synopsis="When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.", ageRating="12", director="Shane Black", leadActors="Robert Downey Jr., Guy Pearce, Gwyneth Paltrow", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
newMovieThorTheDarkWorld = models.Movies(movieTitle="Thor: The Dark World", synopsis="When Dr. Jane Foster gets cursed with a powerful entity known as the Aether, Thor is heralded of the cosmic event known as the Convergence and the genocidal Dark Elves.", ageRating="12", director="Alan Taylor", leadActors="Chris Hemsworth, Natalie Portman, Christopher Eccleston", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
newMovieCaptainAmericaTWS = models.Movies(movieTitle="Captain America: The Winter Soldier", synopsis="As Steve Rogers struggles to embrace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat from history: an assassin known as the Winter Soldier.", ageRating="12", director="Joe Russo, Anthony Russo", leadActors="Chris Evans, Samuel L. Jackson, Scarlett Johansson, Robert Redford, Sebastian Stan, Anthony Mackie", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
...
newMovieDoctorStrange = models.Movies(movieTitle="Doctor Strange", synopsis="While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.", ageRating="12A", director="Scott Derrickson", leadActors="Benedict Cumberbatch, Chiwetel Ejiofor, Rachel McAdams, Tilda Swinton, Mads Mikkelsen", moviePoster="app/static/images/image", carasellPoster="app/static/images/image")
